function simulateHT(data) {
    applyHTStatistics(data);
}
...
function maleHTStatistics(data, malePercentageArray, ageGroupsArray) {
...
function femaleHTStatistics(data, femalePercentageArray, ageGroupsArray) {
