function simulateDA(data) {
    applyDAStatistics(data);
}

function applyDAStatistics(data) {
    let ageGroups = [0, 4, 5, 14, 15, 24, 25, 34, 35, 44, 45, 54, 55, 64, 65, 74, 75, 200];
    let percentageOfMalesAffected = [28, 9, 9, 10, 11, 13, 17, 23, 37];
    let percentageOfFemalesAffected = [27, 12, 28, 25, 24, 25, 29, 32, 42];

    maleDAStatistics(data, percentageOfMalesAffected, ageGroups);
    femaleDAStatistics(data, percentageOfFemalesAffected, ageGroups);
}

function maleDAStatistics(data, malePercentageArray, ageGroupsArray) {
...
function femaleDAStatistics(data, femalePercentageArray, ageGroupsArray) {
