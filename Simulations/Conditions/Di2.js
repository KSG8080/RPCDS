function simulateDi2(data) {
    applyDi2Statistics(data);
}

function applyDi2Statistics(data) {
    let ageGroups = [0, 9, 10, 19, 20, 29, 30, 39, 40, 49, 50, 59, 60, 69, 70, 79, 80, 200];
    let percentageOfMalesAffected = [0.1, 0.6, 1.1, 1.8, 4.9, 9.6, 13.3, 12.4, 6.6];
    let percentageOfFemalesAffected = [0.1, 0.5, 0.8, 1.4, 3.8, 7.5, 10.5, 9.8, 5.2];

    maleDi2Statistics(data, percentageOfMalesAffected, ageGroups);
    femaleDi2Statistics(data, percentageOfFemalesAffected, ageGroups);
}

function maleDi2Statistics(data, malePercentageArray, ageGroupsArray) {
...
function femaleDi2Statistics(data, femalePercentageArray, ageGroupsArray) {
